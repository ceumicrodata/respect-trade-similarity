...
for file in data_list:
        ...
        pd.DataFrame(pd.read_csv(file).fillna(0).groupby(["DECLARANT_ISO","PARTNER_ISO"])["almost_index"].sum()).rename(columns= { "almost_index":"index"}).to_csv("../temp/index"+file[-14:-4]+"_index.csv")
